...
nav_data = [
    [
        ...
        Paragraph("🏘️<br/><b>🏡 Propiedades</b>", styles['NavItem']),
        Paragraph("📋<br/><b>⚙️ Servicios</b>", styles['NavItem']),
...
<font color='#2c3e50'>🏘️ Santa Marta, Boquerón, Paraguay</font><br/><br/>

<font color='#34495e'><b>🌱 APTITUD</b></font><br/>
<font color='#2c3e50'>🌾 Mixto (Agrícola + Ganadero)</font><br/><br/>

<font color='#34495e'><b>🌧️ PRECIPITACIÓN ANUAL</b></font><br/>
...
puntos_interes = """
<font color='#34495e'><b>🗺️ PUNTOS DE INTERÉS</b></font><br/>
<font color='#2c3e50'>🥛 Ruta de la leche: 76 km</font><br/>
<font color='#2c3e50'>🏘️ Neuland: 150 km</font><br/>
<font color='#2c3e50'>🏘️ Filadelfia: 190 km</font><br/>
<font color='#2c3e50'>🏘️ Mariscal Estigarribia: 250 km</font><br/>
<font color='#2c3e50'>🏛️ Asunción: 500 km</font><br/>
"""
...
links_data = [
    [
        ...
        Paragraph(f"📍<br/><b><a href='{maps_link}' color='white'>Google Maps</a></b><br/><font size='9'>🗺️ Ver ubicación</font>", 
                 ParagraphStyle(name='LinkBox', fontSize=11, leading=14, alignment=1, textColor=colors.white)),
...
<font color='#3498db'>📍 <a href="{maps_link}">🗺️ Ver ubicación en Google Maps</a></font><br/>
...
if galeria['imagen_principal'] or galeria['miniaturas']:
    ...
    <font color='#3498db'><a href='https://drive.google.com/drive/folders/XXXXXXX'>🔗 Ver galería completa</a></font>
    """
